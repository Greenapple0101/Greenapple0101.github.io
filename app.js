(function () {
  ...
  function readUrlState() {
    ...
    activeCategory = categories.includes(cat) ? cat : "";
  ...
  if (pagination) {
    pagination.addEventListener("click", (e) => {
      ...
      if (raw === "prev") goToPage(currentPage - 1, filtered);
      else if (raw === "next") goToPage(currentPage + 1, filtered);
      else goToPage(parseInt(raw, 10), filtered);
