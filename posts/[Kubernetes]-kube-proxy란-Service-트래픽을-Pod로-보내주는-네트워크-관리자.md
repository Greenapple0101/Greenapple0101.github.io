...
source: "https://velog.io/@yorange50/Kubernetes-kube-proxy%EB%9E%80-Service-%ED%8A%B8%EB%9E%98%ED%94%BD%EC%9D%84-Pod%EB%A1%9C-%EB%B3%B4%EB%82%B4%EC%A3%BC%EB%8A%94-%EB%84%A4%ED%8A%B8%EC%9B%8C%ED%81%AC-%EA%B4%80%EB%A6%AC%EC%9E%90"
published: "Fri, 29 May 2026 00:11:56 GMT"
backup_date: "2026-05-29T14:51:00.461105"
---

쿠버네티스에서 Service를 공부하다 보면 이런 말을 자주 듣는다.

> Service는 Pod 앞에 고정된 IP를 만들어준다. 클라이언트는 Pod IP를 몰라도 Service IP로 접근하면 된다.
...
“Service는 그냥 추상적인 객체라며?” “그럼 Service IP로 들어온 요청은 실제 Pod IP로 누가 보내주는 거지?” “Service가 진짜 서버처럼 트래픽을 받아서 넘겨주는 건가?”
...
kube-proxy는 규칙을 만든다. 실제 패킷 처리는 리눅스 커널의 iptables가 한다.
