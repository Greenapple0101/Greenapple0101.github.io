---
title: "[Kubernetes] Fluent Bit이 뭔데 로그 수집할 때 자꾸 나올까?"
source: "https://velog.io/@yorange50/Kubernetes-Fluent-Bit%EC%9D%B4-%EB%AD%94%EB%8D%B0-%EB%A1%9C%EA%B7%B8-%EC%88%98%EC%A7%91%ED%95%A0-%EB%95%8C-%EC%9E%90%EA%BE%B8-%EB%82%98%EC%98%AC%EA%B9%8C"
published: "Wed, 27 May 2026 17:53:15 GMT"
backup_date: "2026-05-29T14:51:00.502765"
---
...
이때 등장하는 도구가 **Fluent Bit** 이다.

* * *

# 1\. Fluent Bit이란?

Fluent Bit은 한마디로 **가벼운 로그 수집기** 다.
...
즉, Fluent Bit은 **분산된 로그를 중앙으로 모아주는 수집기** 라고 보면 된다.
...
nginx는 웹 서버 역할을 하고, Fluent Bit은 nginx가 남긴 로그를 읽어서 OpenSearch로 보낸다.
...
두 번째 방식은 **Cluster-level 로그 수집** 이다.
...
Sidecar로 붙이면 특정 앱 로그를 세밀하게 수집할 수 있고, DaemonSet으로 띄우면 클러스터 전체 로그를 공통 방식으로 수집할 수 있다.
